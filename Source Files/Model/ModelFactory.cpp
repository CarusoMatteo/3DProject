...
shared_ptr<Model> ModelFactory::plane(const string name, const fvec2 size, const shared_ptr<Renderer> shader, const Transform modelTransform, const optional<shared_ptr<Texture>> texture)
{
...
shared_ptr<Model> ModelFactory::cube(const string name, const float length, const shared_ptr<Renderer> shader, const Transform modelTransform, const optional<shared_ptr<Texture>> texture)
{
...
shared_ptr<Model> ModelFactory::sphere(const string name, const fvec3 radius, const shared_ptr<Renderer> shader, const Transform modelTransform, const optional<shared_ptr<Texture>> texture)
{
